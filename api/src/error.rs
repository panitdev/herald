        ...
        let (status, msg): (StatusCode, String) = match &self {
            ...
            AppError::Db(e) => {
                ...
                match e {
                    ...
                    _ => (StatusCode::INTERNAL_SERVER_ERROR, "database error".to_owned()),
                }
            }
            AppError::Pool(_) => (StatusCode::SERVICE_UNAVAILABLE, "service unavailable".to_owned()),
            AppError::Http(_) => (StatusCode::BAD_GATEWAY, "upstream error".to_owned()),
            AppError::Internal => (StatusCode::INTERNAL_SERVER_ERROR, "internal error".to_owned()),
        };
